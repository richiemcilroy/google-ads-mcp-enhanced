...
class TestToolsConfig(unittest.TestCase):
    ...
    def test_default_config_exposes_all_with_default_namespaces(self):
        ...
        self.assertTrue(config.is_namespace_enabled("planning"))
        self.assertTrue(config.is_namespace_enabled("reports"))
        self.assertTrue(config.is_namespace_enabled("recommendations"))
        self.assertFalse(config.is_namespace_enabled("conversions"))
        self.assertFalse(config.is_namespace_enabled("mutations"))
